...
<!--    <?//= $form->field($model, 'continent')->textInput(['maxlength' => true])->label('Continent',['class'=>'mb-2 fw-bold']) ?>-->
    <?php
    ...
    <?= $form->field($model, 'code2')->textInput(['maxlength' => true])->label('Code2',['class'=>'mb-2 fw-bold']) ?>
