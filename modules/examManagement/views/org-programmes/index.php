    ...
    <div class="card" >
        ...
        <!-- 
            <div class="d-flex justify-content-end">
                 <?= Html::a('<i class="bi bi-plus-lg"></i> Create Programmes', ['/setup/org-programmes/create'], ['class' => 'btn btn-primary']) ?>
            </div>
            --> 
            ...
            [
                ...
                'buttons' => [
                    'update' => function ($url, $model, $key) {
                        return  Html::a(' Level Requirements', ['/exam-management/prog-curr-level-requirement/index','prog_curriculum_id' => $model->prog_id], ['class' => ' bi bi-pencil-square btn btn-outline-primary btn-sm']);
                    }
                ]
