...
/**
 * KuccpsProgMapSearch represents the model behind the search form of `app\models\KuccpsProgMap`.
 */
class KuccpsProgMapSearch extends KuccpsProgMap
{
    /**
     * {@inheritdoc}
     */
