...
/**
 * AcademicLevelsSearch represents the model behind the search form of `app\models\AcademicLevels`.
 */
class AcademicLevelsSearch extends AcademicLevels
{
    /**
     * {@inheritdoc}
     */
