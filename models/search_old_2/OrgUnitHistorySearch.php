...
class OrgUnitHistorySearch extends OrgUnitHistory
{
    ...
    public function rules()
    {
        return [
            ...
            [['start_date', 'end_date', 'date_created','orgUnit','orgType','unitHead'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->joinWith(['orgUnit','orgType','unitHead']);
        ...
        $query->andFilterWhere([
            ...
            'unit_id' => $this->org_unit_id,
            'unit_type_id' => $this->org_type_id,
            'unit_head_id' => $this->unit_head_id
        ]);
